...
import { loginWithDiscord, loginWithGoogle } from './oauth-actions';
    ...
    <div className={styles.authPage}>
      <div className={styles.authCard}>
        ...
        <div className={styles.socialBtns}>
          <form action={() => loginWithDiscord(callbackUrl)} style={{ width: '100%' }}>
            <button
              type="submit"
          ...
          <form action={() => loginWithGoogle(callbackUrl)} style={{ width: '100%' }}>
            <button
              type="submit"
        ...
        <p className={styles.switchLink}>
          {t('auth.no_account')} <Link href="/register">{t('auth.register_btn')}</Link>
        </p>
      </div>
    </div>
  );
